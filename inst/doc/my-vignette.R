...
# calculate_ps(munich_pollen[,c(1,6)], method = "percentage", perc = 90, export.result = FALSE)
...
## ----echo = TRUE, results='hide',fig.keep='all', eval=FALSE-------------------
# plot_trend(munich_pollen, interpolation = FALSE, export.plot = FALSE, export.result = FALSE)
