...
#' @examples iplot_abundance (munich, interpolation = FALSE, export.plot = FALSE)
...
annual.sum.data <<- sum.data

if (type.plot == "static") {return(plot.abundance)}
if (type.plot == "dynamic") {return(ggplotly(plot.abundance))}
